...
| 可排版 | 用 Flow 排列 capability、stage、输入输出、Checkpoint 与 lifecycle 声明。 |
...
| 版式 | `Flow` | capability-first stages、Checkpoint 位置与 Lifecycle Handler 声明。 |
| 锁版印刷 | `Run` | 一次 explain、dryRun 或 execute snapshot；锁定 refs 与 bindings。 |
